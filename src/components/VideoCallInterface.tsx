    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center p-4 bg-blue-50 rounded-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-lg">{provider?.provider || 'Dr. Default Provider'}</h3>
            <p className="text-sm text-muted-foreground">{provider?.specialty}</p>
            {isVeteran && (
              <Badge className="text-xs bg-amber-100 text-amber-800 mt-1">
                🎖️ Veteran Care Specialist
              </Badge>
            )}
          </div>
        </div>
              ...
              <div className="relative bg-gray-900 rounded-lg aspect-video flex items-center justify-center">
                {isVideoOn ? (
                  <div className="text-white text-center">
                    ...
                    <p className="text-lg font-medium">{provider?.provider || 'Dr. Default Provider'}</p>
